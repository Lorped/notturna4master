...
export class ModificaPage implements OnInit {
  ...
  loadoggetto() {
    var url =
      'https://www.roma-by-night.it/ionicPHP/barcode3.php?barcode=' +
      this.barcode;
  ...
  edit(x: Condizione) {
    ...
    this.router.navigate([
      'modifica/' + this.barcode + '/' + x.con.idcondizione,
    ]);
  }
  ...
  delete(x: Condizione) {
    ...
    var url =
      'https://www.roma-by-night.it/ionicPHP/delcond.php?idcondizione=' +
      x.con.idcondizione;
